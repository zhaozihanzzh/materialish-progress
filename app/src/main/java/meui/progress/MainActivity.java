    ...
    public void onClick(View p1)
    {
        switch(p1.getId()){
            ...
            case R.id.can_work:
                ...
                final Uri tiebaGuide=Uri.parse("http://tieba.baidu.com/f?kw=%E5%8D%8E%E4%B8%BAy220t10&frs=yqtb");
                final Intent guide=new Intent(Intent.ACTION_VIEW,tiebaGuide);
                startActivity(guide);
                break;
            case R.id.cant_work:
                ...
                final Uri tiebaReport=Uri.parse("http://tieba.baidu.com/f?kw=%E5%8D%8E%E4%B8%BAy220t10&frs=yqtb");
                final Intent report=new Intent(Intent.ACTION_VIEW,tiebaReport);
